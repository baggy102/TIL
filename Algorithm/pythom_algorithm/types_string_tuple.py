...
문자열 안에 큰따옴표나 작은따옴표가 포함되어야 하는 경우
 ...
 - 혹은 백슬래시를 사용하면, 큰따옴표나 작은따옴표를 원하는 만큼 포함시킬 수 있습니다.
'''
...
# 문자열 연산
'''
문자열 변수에 덧셈을 이용하면 문자열이 더해져 연결(Concatenate)된다.
...
a = "ABCDEF"
print(a[2 : 4])
# a[2] = 'a' -> err : 'str' object does not support item assignment.


# 튜플 자료형 
'''
튜플 자료형은 리스트와 유사하지만 약간의 문법적 차이가 있다.
...
a = (1, 2, 3, 4)
print(a)
# a[2] = 7 -> err : 'tuple' object does not support item assignment
